...
(function() {
    ...
    this.compileShaderSource = function(shaderName, shaderSource, shaderType)
    {
        ...
        if (!success) 
        {
            ...
            console.log(shaderName + ' ' + shaderTypeStr + ': ' + gl.getShaderInfoLog(shader));
            return null;
        }
        return shader;
    }
    ...
    */
    this.Shader = function(name, shaderSources, replacements)
    {
        ...
        {
            console.log("failed to link: " + gl.getProgramInfoLog(this.program));
            this.program = null;
        }
        this.uniforms = {};
    }
    ...
    */
    ...
    this.fail = function(message)
    {
		...
		sorryP.appendChild(document.createTextNode("[Party] error occurred:"));
		...
		throw new Error("Terminating Party");
    }
